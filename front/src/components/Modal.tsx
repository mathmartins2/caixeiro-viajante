import { Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, FormControl, FormLabel, Input, ModalFooter, InputGroup, InputLeftElement, FormErrorMessage, useToast } from "@chakra-ui/react";
...
function ModalComponent({ isOpen, onClose }: Readonly<ModalProps>) {
  ...
  const mutation = useMutation({
    mutationFn: (newCustomer: Customer) => CustomerRepository().createCustomer(newCustomer),
    onSuccess: () => {
      toast({
